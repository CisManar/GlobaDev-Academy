...
Only One node per language in the selected content types for this configuration.
 ...
 * Configure the content types in Administration » Configuration »
   ...
   - In the 'Available content types for Only One' section check the content
     types that should have Only One node per language. For this you need the
 ...
 * Configure the module settings in Administration » Configuration »
   ...
   - If you want to have the configured content types in a new menu entry named
     ...
     Administration » Content, then the 'Add content' menu link will show the 
     not configured content types. For this you need the 'Administer Only One'
     permission.
